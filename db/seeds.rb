...
1.times do
  ...
  santa = User.create!(first_name: "Santa",last_name: "Cadusch", email: "santacadusch@icloud.com", password: "123456")
    ...
    Car.create!([{title:'Delivers quality, comfort and excitment', model: 'BMW 2-Series', description: 'Lively driving dynamics, superb powertrains, upscale exterior styling.', year: rand(1998..2021), photo: 'https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/2020-bmw-2-series-mmp-1-1579124677.jpg?crop=0.503xw:0.447xh;0.247xw,0.338xh&resize=768:*', city: "Zug", price: rand(100..400), user: user },
      ...
      car = Car.create!(title:'Sporty and handsome - perfect for holidays', model: 'Porsche 911 Carrera 4S', description: "Beneath the 911's constant, nearly timeless veneer hides a lot of fevered engineering work balancing modern vehicle regulations with lush dynamic characteristics and speed.", year: 2020, photo: 'https://robbreport.com/wp-content/uploads/2019/03/911-carrera-c.jpg?w=1000', city: "St.Gallen", price: 320, user: user)

      rev = Review.create!(content: "I rented this car for my holiday and it was spectacular! This car is fast and beautiful, I would rent it again! Recommend to all. - Julian Shaw, Apr 2021", car: car)
      revw = Review.create!(content: "Wunderbares Cabrio für jede Reise. Wir hatten viel Spaß! - Müller Familie, March 2021", car: car)
