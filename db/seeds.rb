...
# {title:'', model: '', description: '', year: rand(1998..2021), photo: '', city:["Zug", "Zurich", "Lausanne", "Luzern", "Geneva", "Bern", "St.Gallen"].sample, price: rand(100..400), user: user }
...
#       year: rand(1998..2021),
#       city:["Zug", "Zurich", "Lausanne", "Luzern", "Geneva", "Bern", "St.Gallen"].sample,
#       price: rand(100..400),
...
#     )
#     end
# curl --silent "https://hiconsumption.com/best-convertibles/" > cars2.html
# curl --silent "https://www.caranddriver.com/features/g27198629/convertibles/" > cars.html
# cars_scrapping = []
# url = "https://www.caranddriver.com/features/g27198629/convertibles/"
# url = "https://www.carwow.co.uk/car-chooser?filter%5Bbody_type%5D=convertibles"
# # url = "https://cars.usnews.com/cars-trucks/rankings/used/convertibles-1"
# doc = "./cars2.html"

# html_file = URI.open(doc).read
# html_doc = Nokogiri::HTML(html_file)

# html_doc.search('.listicle-slide').each do |element|
#   puts element.search('.listicle-slide-hed-text')
#   # puts element.search('.listicle-slide-hed-text').text.strip
#   # puts element.search('.slide-media picture source').attribute('srcset') #unless element.search('.slide-media picture img').attribute('src').nil?
#   # puts element.search('.slide-media picture img.lazyimage').attribute('src').value unless element.search('.slide-media picture img.lazyimage').attribute('src').nil?
#   # puts element.text.strip
#   # puts element.attribute('href').value

#    # cars_scrapping << {title: title, photo: photo, decription: description}
# end
